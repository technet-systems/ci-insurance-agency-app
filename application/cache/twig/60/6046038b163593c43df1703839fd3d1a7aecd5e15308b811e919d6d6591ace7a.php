...
class __TwigTemplate_e8d55dfc874f2e88d9b6b66a0c5f6cf578c268a1366fc9e4f90da06418c0db70 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("base_layout.twig", "company/details.twig", 1);
        $this->blocks = array(
...
";
    ...
    <section class=\"content\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
            ...
            echo twig_escape_filter($this->env, $this->getAttribute($context["product"], "co_notice", array()), "html", null, true);
            echo "</a></td>
                                                <td>
                                                    <a href=\"";
            // line 65
            echo twig_escape_filter($this->env, base_url(("product/details/" . $this->getAttribute($context["product"], "pr_id", array()))), "html", null, true);
                                            ...
                                            <div class=\"modal-content\">
                                                ...
                                                <div class=\"modal-body\">
                                                    <form class=\"form-horizontal\" id=\"product-create\">
                                                        ...
                                                        <div class=\"form-group\"><label for=\"pr_name\" class=\"col-sm-4 control-label\">Rodzaj <code>*</code></label>
                                                            <div class=\"col-sm-8\">
                                                        ...
                                                        <div class=\"form-group\"><label for=\"pr_notice\" class=\"col-sm-4 control-label\">Uwagi</label>
                                                            <div class=\"col-sm-8\">
                                                                <textarea class=\"form-control vertical\" rows=\"3\" placeholder=\"Notatki\" class=\"pr_notice\" id=\"pr_notice\"></textarea>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class=\"modal-footer\">
                                                    ...
                                                    <button type=\"button\" class=\"btn btn-accent\" data-dismiss=\"modal\" id=\"submit\" data-url=\"";
        // line 99
        echo twig_escape_filter($this->env, base_url("product/create"), "html", null, true);
        echo "\">Dodaj</button>
                                                </div>
                                            </div>
                                        </div>
...
";
    ...
    {
        return array (  264 => 147,  261 => 146,  255 => 143,  250 => 142,  247 => 141,  228 => 124,  214 => 118,  207 => 114,  195 => 106,  191 => 105,  182 => 99,  151 => 70,  141 => 66,  137 => 65,  128 => 63,  120 => 62,  115 => 61,  111 => 60,  74 => 26,  60 => 14,  57 => 13,  49 => 9,  46 => 8,  40 => 5,  35 => 4,  32 => 3,  11 => 1,);
    }
                                    ...
                                    <table id=\"tableExample2\" class=\"table table-striped table-hover\">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id=\"pr_id-{{ product.pr_id }}\">
                                                ...
                                                <td><a href=\"#\" class=\"popup_edit\" data-type=\"textarea\" data-pk=\"{{ product.pr_id }}\" data-title=\"Zmiana e-mail\" data-url=\"{{ base_url('product/edit') }}\" data-name=\"co_notice\">{{ product.co_notice }}</a></td>
                                                <td>
                                                    <a href=\"{{ base_url('product/details/' ~ product.pr_id) }}\" class=\"btn btn-success btn-xs\">Szczegóły</a>
                                    ...
                                    <div class=\"modal fade\" id=\"modalADD\" tabindex=\"-1\" role=\"dialog\" aria-hidden=\"true\" style=\"display: none;\">
                                        <div class=\"modal-dialog\">
                                            <div class=\"modal-content\">
                                                ...
                                                <div class=\"modal-footer\">
                                                    <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Anuluj</button>
                                                    <button type=\"button\" class=\"btn btn-accent\" data-dismiss=\"modal\" id=\"submit\" data-url=\"{{ base_url('product/create') }}\">Dodaj</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class=\"modal fade\" id=\"modalDELETE-{{ product.pr_id }}\" tabindex=\"-1\" role=\"dialog\" aria-hidden=\"true\" style=\"display: none;\">
                                        <div class=\"modal-dialog modal-sm\">
                                            <div class=\"modal-content\">
                                                ...
                                                <div class=\"modal-footer\">
                                                    <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Anuluj</button>
                                                    <button type=\"button\" class=\"btn btn-danger submit\" data-url=\"{{ base_url('product/delete') }}\" data-pk=\"{{ product.pr_id }}\" data-dismiss=\"modal\">Usuń</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
{% endblock %}", "company/details.twig", "D:\\xampp\\htdocs\\ci-insurance-agency-app\\application\\views\\company\\details.twig");
    }
}
